...
(
    ...
    `INFORMATION` TEXT,
     PRIMARY KEY (ID),
     FOREIGN KEY (OWNER) REFERENCES USERS(ID) ON UPDATE CASCADE ON DELETE CASCADE,
     FOREIGN KEY (FILE) REFERENCES FILES(ID) ON UPDATE RESTRICT ON DELETE RESTRICT,
...
INSERT INTO PREFERENCES (ID, HIDE_PUBLIC_OWNED)
VALUES (1, TRUE);

INSERT INTO FILES (NAME, TYPE, OWNER, PUBLIC, SIZE, BLOCKED)
VALUES ('example', 'dbm', 1, TRUE, 726, FALSE);

INSERT INTO FILES (NAME, TYPE, OWNER, PUBLIC, SIZE, BLOCKED)
VALUES ('example', 'sqlite', 1, TRUE, 13312, FALSE);

INSERT INTO FILES (NAME, TYPE, OWNER, PUBLIC, SIZE, BLOCKED)
VALUES ('test', 'dbm', 1, FALSE, 993, FALSE);

INSERT INTO FILES (NAME, TYPE, OWNER, PUBLIC, SIZE, BLOCKED)
VALUES ('test', 'sqlite', 1, FALSE, 18432, FALSE);
