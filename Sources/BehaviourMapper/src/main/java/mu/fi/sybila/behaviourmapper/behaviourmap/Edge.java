...
/**
 * Class representing an edge in the behaviour map.
 * 
...
public class Edge
{
    ...
    /**
     * Constructor for behaviour map edges.
     * 
     * @param from The node the interaction starts from.
     * @param to The node the interaction leads to.
     */
    ...
    /**
     * Saves the edge information into the output xgmml.
     * 
     * @param doc The XML document to which the data is saved.
     * @param maxTransitionCount The highest number of transitions for every edge in the behaviour map.
     * @return The XML element representing the edge.
     */
